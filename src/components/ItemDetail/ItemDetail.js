	...
	return (
		<Card className="cardDetailContainer">
			<div className="imgDetailContainer">
				<Card.Img className="cardDetailImage" variant="top" src={data.image} />
			</div>
			<div className="cardDetailInfo">
				<Card.Body className="cardDetailBody">
					<Card.Title className="cardDetailTitle">{data.title}</Card.Title>
					<Card.Text className="cardDetailText">{data.detalle}</Card.Text>
					<Card.Text className="cardDetailStock">STOCK: {data.stock}</Card.Text>
